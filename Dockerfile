...
RUN DEBIAN_FRONTEND=noninteractive apt-get -yq install nano cadaver wget apt-transport-https gnupg curl libssl-dev git python3 build-essential tor libusb-dev ftp
