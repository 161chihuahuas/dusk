...
> **Not up for an essay?** Skip straight to the [User Guide](#user-guide).
...
![dusk --help](./assets/dusk_--help.png) 
...
![dusk first run](./assets/dusk.png) 
...
![test hooks](assets/dusk_--test-hooks.png) 
...
![docker testnet](assets/docker-testnet.png) 
...
![dusk rpc getinfo](assets/dusk_--rpc_--control-port.png) 
...
![dusk --shoes](assets/dusk_--shoes.png) 

Shredding a file follows a guided prompt.

![shred shoes](assets/dusk_--shred_--shoes.png) 
